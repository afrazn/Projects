# This finds the longest common subsequence given two strings, (series of letters from left to right they share. Order doesnt matter)
dna_1 = "ACCGTT"
dna_2 = "CCAGCA"
...
def longest_common_subsequence(string_1,string_2):
  ...
  #set up the grid with two nested loops
